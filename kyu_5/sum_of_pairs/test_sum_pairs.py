...
@allure.tag('FUNDAMENTALS', 'PARSING ALGORITHMS',
            'STRINGS', 'MEMOIZATION', 'DESIGN PATTERNS',
            'DESIGN PRINCIPLES')
...
class SumPairsTestCase(unittest.TestCase):
    ...
    def test_sum_pairs(self):
        ...
        test_data = (
            ([1, 4, 8, 7, 3, 15], 8, [1, 7], "should return [1, 7] for sum = 8"),
            ([1, -2, 3, 0, -6, 1], -6, [0, -6], "should return [0, -6] for sum = -6"),
            ([20, -13, 40], -7, None, "should return None for sum = -7"),
            ([1, 2, 3, 4, 1, 0], 2, [1, 1], "should return [1, 1] for sum = 2"),
            ([10, 5, 2, 3, 7, 5], 10, [3, 7], "should return [3, 7] for sum = 10"),
            ([4, -2, 3, 3, 4], 8, [4, 4], "should return [4, 4] for sum = 8"),
            ([0, 2, 0], 0, [0, 0], "should return [0, 0] for sum = 0"),
            ([5, 9, 13, -3], 10, [13, -3], "should return [13, -3] for sum = 10"),
        )
