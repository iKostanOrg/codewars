...
class SumOfPowerOfTwoTestCase(unittest.TestCase):
    ...
    def test_powers(self):
        ...
        test_data: tuple = (
            ...
            ("Pass n = 134217736 and verify the output", 134217736, [8, 134217728]),
            ("Pass n = 140737488355330 and verify the output", 140737488355330,
             [2, 140737488355328]),
            ("Pass n = 35184372088896 and verify the output", 35184372088896,
             [64, 35184372088832]),
