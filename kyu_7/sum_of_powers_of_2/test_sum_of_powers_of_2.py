...
class SumOfPowerOfTwoTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("Pass n = 9007199254740991 and verify the output",
         9007199254740991,
    ...
    def test_powers(self, message, number, expected):
        """
        Test powers function with various test data.

        :return:
        """
        # pylint: disable-msg=R0801
        allure.dynamic.title("'powers' function should return an "
        ...
        with allure.step(message):
            print_log(n=number, expected=expected, message=message)
