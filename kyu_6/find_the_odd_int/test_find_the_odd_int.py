...
class FindTheOddIntTestCase(unittest.TestCase):
    ...
    @parameterized.expand([
        ([20, 1, -1, 2, -2, 3, 3, 5, 5, 1, 2, 4, 20, 4, -1, -2, 5],
         5, 'should return 5 (because it appears 3 times)'),
        ([5, 4, 3, 2, 1, 5, 4, 3, 2, 10, 10],
         1, 'should return 1 (because it appears 1 time)'),
        ...
        ([14, 2, -3, -12, -17, 14, 2, 2, -17, -17, -12, -12, 14, -17, -1,
         ...
         2, 'Random tests')])
    def test_something(self, lst, expected, msg):
        """
        Sample testing.
        ...
        with allure.step("Assert test result:"):
