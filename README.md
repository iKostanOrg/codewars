...
|  5  |       asteval        | The asteval module allows you to evaluate a large subset of the Python language from within a python program, without using eval().                                  |   [Source](https://lmfit.github.io/asteval/motivation)    |
